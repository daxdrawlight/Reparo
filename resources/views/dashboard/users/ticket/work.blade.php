<div class="work-content col s12 no-pad work-data">
	<div class="input-field col s12 m6">
		<input disabled type="text" class="validate" name="work[]" value="@if(!empty($work)){{ $work }}@endif" autocomplete="off">
		<label for="work[]">Opis rada</label>				
	</div>
	<div class="input-field hours col s12 m2">
		<input disabled type="text" class="validate hours center-align" name="hours[]" value="@if(!empty($hours)){{$hours[$key]}}@endif" autocomplete="off">
		<label for="hours[]">Sati</label>
	</div>
	<div class="input-field pph col s12 m2">
		<input disabled type="text" class="validate pph center-align" name="pph[]" value="@if(!empty($pphs)){{$pphs[$key]}}@endif" autocomplete="off">
