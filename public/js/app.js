...
$(document).on('click', '.add-btn', function (e) {
    ...
    currentEntry = $(this).parents('.part-content:first').siblings('.part-content:first'), newEntry = $(currentEntry.clone()).appendTo(partContent);
...
Component.options.__file = "c:\\xampp\\htdocs\\reparo\\resources\\assets\\js\\components\\Example.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c899bdf6", Component.options)
  } else {
    hotAPI.reload("data-v-c899bdf6", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-c899bdf6", module.exports)
  }
}
